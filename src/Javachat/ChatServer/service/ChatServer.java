package Javachat.ChatServer.service;
...
import Javachat.ChatServer.util.ServerTime;
import Javachat.ChatServer.util.WriteLog;
...
public class ChatServer {
    ...
    public static void loadUser(){//将用户信息从文件里读出来
        File userfile = new File("src//Javachat//ChatServer//service//user.txt");
        try{
    ...
    private boolean registerUser(String userId, String passwd){
        ...
        FileWriter writer;
        try {
            writer = new FileWriter("src//Javachat//ChatServer//service//user.txt",true);
